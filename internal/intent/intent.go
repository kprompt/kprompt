...
const SchemaJSON = `{
  ...
  "properties": {
    "kind": {
      "type": "string",
      "enum": ["deploy", "install", "upgrade", "scale", "rollback", "get", "explain", "logs", "describe", "workflow", "tekton", "keda", "performance", "trace", "dashboard", "optimize", "graph", "delete", "deny", "unknown"]
    },
    "target": {
      "type": "object",
      "additionalProperties": false,
