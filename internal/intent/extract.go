...
Rules:
- kind must be one of: deploy, install, scale, rollback, get, explain, logs, describe, workflow, tekton, keda, performance, trace, dashboard, optimize, graph, delete, deny, unknown
