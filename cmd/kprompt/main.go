...
Bare kprompt (no args) prints a readiness coach. Full help: kprompt --help · kprompt advanced`,
	...
	root.PersistentFlags().StringVar(&provider, "provider", "", "LLM provider (openai|anthropic|gemini|groq|xai|cerebras|mistral|deepseek|moonshot|openrouter|together|fireworks|ollama|lmstudio|azure|openai-compatible)")
